...
<body class="background">
    ...
    <section class="mainPanel" style="width: 100%;">
        ...
        <div class="history" style="transform: translateY(40%); width: 80%; margin: auto;" align="center">
            <div class="secHeading">
                ...
                <font class="text" style="color: #08aeea;">Files you've uploaded</font>
            </div>
            <div class="secMain">
    ...
    <?php
        ...
        echo  "<tr>
                <td>
                    <font class='file-title'>" .$row['filename']."</font>
                </td>
                <td>
                    <font class='file-history'>".$row['uploadtime'] ."</font>
                </td>
                <td>
                    <i class='fa fa-trash delete-icon' aria-hidden='true' id='".$row['filename']."'></i>
                </td>
                </tr>";

        echo "<script type='text/javascript'>                    
                document.getElementById('".$row['filename']."').addEventListener('click',function(){
                    if(confirm('Do you want to delete??'))
                    {
                        window.location.href='delete.php?del_id=".$row['filename']."';
                        return true;
                    }
                });            
            </script>";
