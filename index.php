...
<body class="background">
	<div class="navbar">
		<ul>
			...
			<!--Continuous improvement-->
  			...
  			<!--login-->
  			<div class="dropdown" style="float: right;"><li class="dropdown"><button class="dropbutton" onclick="LogIn()"><i class="fa fa-user" aria-hidden="true"></i>  <font id="status">Admin Login</font></button>
  				<!--dropdown for login-->
  			<div class="dropdown-content" id="login">
  				<form class="login-form" style="width: 100%" method="post" action="#">
    ...
    <!--view button-->
 		<p style="padding: 5px;"> <input type="submit" value="View Result" class="button" style="padding-top: 10px;padding-bottom: 10px;" /> </p>
		</form>
	</div>
